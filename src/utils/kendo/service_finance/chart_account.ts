export const colChartAccount = [
    { field: 'id',title:"N",editable: false,width: '90px',resizable: false, columnMenu: 'myTemplate',headerClassName: 'customMenu'}, 
    ...
    { field:"libelle", title : "Libellé", editable: false,filter:'text',editor: false,width: '690px',resizable: false, columnMenu: 'myTemplate',headerClassName: 'customMenu'}, 
